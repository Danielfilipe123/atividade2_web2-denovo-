...
@section('content')
<div class="container">
    <h1 class="my-4">Lista de Publicadoras</h1>

    <a href="{{ route('publishers.create') }}" class="btn btn-success mb-3">
        <i class="bi bi-plus"></i> Adicionar Publicadora
    </a>
    ...
    <table class="table table-striped">
        ...
        <tbody>
                ...
                <tr>
                    ...
                    <td>
                        ...
                        <form action="{{ route('publishers.destroy', $publisher) }}" method="POST" style="display: inline;">
                            @csrf
                            @method('DELETE')
                            <button class="btn btn-danger btn-sm" onclick="return confirm('Deseja excluir esta publicadora?')">
            ...
            @empty
                <tr>
                    <td colspan="3">Nenhuma Publicadora encontrada.</td>
                </tr>
            @endforelse
        </tbody>
    </table>
